...
export const SOURCES = [
  ...
  { name: 'Sifted', domain: 'sifted.eu', note: 'European startups and funding' },
  {
    name: 'Axios Pro Fintech Deals',
    domain: 'axios.com',
    note: 'deal flow reporting — mostly paywalled, use whatever is publicly visible',
  },
];
...
You have a limited number of searches, so be efficient: go straight at the 2-4 sources most likely to have this week's relevant news rather than exhaustively covering all six.
